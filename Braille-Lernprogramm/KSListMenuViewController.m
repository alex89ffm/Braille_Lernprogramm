...
@interface KSListMenuViewController ()

@end

@implementation KSListMenuViewController
...
{
    KSListViewController *KSLVC = [[KSListViewController alloc]initWithType:theButton.tag];
    [self.navigationController pushViewController:KSLVC animated:YES];
}
